...
namespace SubSonic.Query
{
    ...
    /// 
    /// </summary>
    public class Upsert : ISqlQuery
    {
        private readonly IDataProvider _provider;
        public List<string> ColumnList = new List<string>();
        public List<UpsertSetting> Upserts = new List<UpsertSetting>();
        internal ITable Table;
        private string tableName = "";

        /// <summary>
        /// Initializes a new instance of the <see cref="Upsert"/> class.
        /// </summary>
        public Upsert() : this(ProviderFactory.GetProvider()) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="Upsert"/> class.
        /// </summary>
        /// <param name="provider">The provider.</param>
        public Upsert(IDataProvider provider)
        {
            _provider = provider;
        }
        ...
        public string BuildSqlStatement()
        {
            ...
            string sql = generator.BuildUpsertStatement();
            return sql;
        }
        ...
        public Upsert Into<T>(params Expression<Func<T, object>>[] props)
        {
            ColumnList.Clear();
        ...
        /// <returns></returns>
        public Upsert Into<T>(params string[] columns) where T : new()
        {
            ColumnList.Clear();
        ...
        /// <returns></returns>
        public Upsert Into<T>(ITable tbl) where T : new()
        {
            ColumnList.Clear();
            Table = tbl;
            tableName = tbl.Name;
        ...
        private Upsert AddValues(bool isExpression, params object[] values)
        {
        ...
        {
            UpsertSetting setting = new UpsertSetting
                                        {
        ...
        /// <returns></returns>
        public Upsert Value(string column, object columnValue)
        {
        ...
        /// <returns></returns>
        public Upsert Value(string column, object columnValue, DbType dbType)
        {
        ...
        /// <returns></returns>
        public Upsert Values(params object[] values)
        {
        ...
        /// <param name="values">The values.</param>
        /// <returns></returns>
        public Upsert ValueExpression(params object[] values)
        {
        ...
        public QueryCommand GetCommand()
        {
            ...
            //add in the commands
            foreach(UpsertSetting s in Upserts)
            {
